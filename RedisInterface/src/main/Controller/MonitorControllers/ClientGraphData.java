...
/**
 * Created by ankit on 12/9/14.
 */
public class ClientGraphData extends HttpServlet {
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String key=ipaddress+":"+portno+":"+"connected_clients";
        ...
        for (String s: data)
        {
            ...
            if(formattedDate.equals(prevDate))
                map.put(formattedDate, Long.toString((long)((Double.parseDouble(map.get(formattedDate)) + Double.parseDouble(splits[1]))/2)));
            else
                map.put(formattedDate, Long.toString((long)(Double.parseDouble(splits[1]))));
